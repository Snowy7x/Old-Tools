...
namespace Snowy.Core.Base
{
  ...
  public class BehaviourTree : ScriptableObject
  {
    ...
    protected BehaviourIterator mainIterator;

    // Active timers that tick while the tree runs.
    protected Utility.UpdateList<Utility.Timer> activeTimers;
    ...
    protected bool isTreeInitialized = false;
...
#pragma warning restore IDE0044 // Add readonly modifier
    ...
    public virtual void SetNodes(IEnumerable<BehaviourNode> nodes)
    {
    ...
    public virtual void SetNodes(BehaviourNode root)
    {
    ...
    /// <returns></returns>
    public virtual BehaviourNode GetNode(int preOrderIndex)
    {
    ...
    /// </summary>
    public virtual void AddTimer(Utility.Timer timer)
    {
    ...
    /// </summary>
    public virtual void RemoveTimer(Utility.Timer timer)
    {
    ...
    public virtual int ActiveTimerCount
    {
    ...
    /// <returns></returns>
    public virtual IEnumerable<T> GetNodes<T>() where T : BehaviourNode
    {
    ...
    protected virtual void SetRootIteratorReferences()
    {
    ...
    /// </summary>
    protected virtual void SetPostandLevelOrders()
    {
    ...
    public virtual BehaviourNode.Status LastStatus()
    {
    ...
    protected virtual void ClearChildrenStructure(BehaviourNode node)
    {
      if (node.IsComposite())
      {
    ...
    protected virtual void AddBlackboardAsset()
    {
