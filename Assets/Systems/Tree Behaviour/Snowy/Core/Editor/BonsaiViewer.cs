...
namespace Snowy.Designer
{
  public class BonsaiViewer
  {
    ...
    {
      return node.Behaviour.StatusEditorResult == BehaviourNode.StatusEditor.Running;
    }
    ...
    {
      BehaviourNode behaviour = node.Behaviour;
      BehaviourIterator itr = behaviour.Iterator;

      if (itr != null && itr.IsRunning)
      {
        var aborter = behaviour as ConditionalAbort;
